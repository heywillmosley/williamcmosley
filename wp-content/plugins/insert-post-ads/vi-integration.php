...
function insert_ads_vi_signup_form_get_content() {
	...
	if(true) {
		echo '<div class="insert_ads_popup_content_wrapper">';	
			echo '<iframe src="'.$signupURL.'?email='.get_bloginfo('admin_email').'&domain='.insert_ads_get_domain_name_from_url(get_bloginfo('url')).'&aid=WP_insert" style="width: 100%; max-width: 870px; min-height: 554px;"></iframe>';
