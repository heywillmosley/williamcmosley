...
// JSON_PRETTY_PRINT only supported in PHP 5.4
if ( version_compare( PHP_VERSION, '5.4.0' ) >= 0 ) {
	$data = json_encode( FLBuilderUISettingsForms::get_js_config(), JSON_PRETTY_PRINT );
} else {
	$data = json_encode( FLBuilderUISettingsForms::get_js_config() );
}
?>

<script>
( function( $ ) {
	$.extend( FLBuilderSettingsConfig, <?php echo $data; ?> );
} )( jQuery );
<?php
